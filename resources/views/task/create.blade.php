...
<div class="container" id="cont">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <button onclick="window.history.back();" class="btn btn-secondary float-left"><i class="fas fa-arrow-left"></i> Retour</button>

            <div class="card">
                <div class="card-header">{{ __('Enregistrement') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('task.create', ['group_id' => $group_id]) }}">
                        @csrf
