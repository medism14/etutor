...
<div class="container" id="cont">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <a href="{{ route('resource.shows',['project_id' => $project_id]) }}" class="btn btn-secondary float-left"><i class="fas fa-arrow-left"></i> Retour</a>
            <div class="card">
    ...
    @endif
                <div class="card-body">
                    <form method="POST" action="{{ route('resource.create', ['project_id' => $project_id]) }}" enctype="multipart/form-data">
                        @csrf
